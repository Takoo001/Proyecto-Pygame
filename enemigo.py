...
class Enemigo(Entidad):
    def __init__(self, x, y):
        ...
        # hitbox sincronizada con el rect visual
        self.hitbox = pg.Rect(self.rect.x, self.rect.y, 64, 64)
...
class EnemigoPequeno(Enemigo):
    def __init__(self, x, y):
        ...
        self.sprite_ataque = pg.image.load(
            "assets/sprites_enemigos/ataque_español_pequeño.png"
        ).convert_alpha()
